  ...
  return (
    <div className="nav">
      <div className="container flex items-center justify-between h-16 md:h-24">
        <img src="https://avatars.githubusercontent.com/u/107359025?s=400&u=016ac865331a7408789cec3dda8e2c5a4ad151f3&v=4" alt="" className="w-16 md:w-24 h-16 md:h-24 -ml-4 md:-ml-10"/>
        <div>
        ...
        <div className="w-5 h-5 flex flex-col justify-between items-center md:hidden text-4xl duration-300 cursor-pointer overflow-hidden group">
