...
Samouk z pasją do rozwoju - szukam ambitnych projektów, w których mogę wnieść realną wartość. Na co dzień pracuję z technologiami takimi jak **Laravel**, **Nuxt**, **Vue**, **Next**, **React**, **Symfony**, Django, Prestashop i WordPress, tworząc przyjazne interfejsy z CSS3/SCSS, PrimeVue, GSAP, Tailwind i Material UI.

Stawiam na niezawodny, łatwy w utrzymaniu kod - testuję z Pest, PHPUnit, Jest, Vitest, Cypress i Storybook. Mam też doświadczenie w DevOps, Docker i CI/CD, a cyberbezpieczeństwo traktuję jako dodatkową dziedzinę rozwoju.

Twórca i główny developer [Nucleify](https://nucleify.io/pl/dev) - modularnego frameworka full-stack (Laravel + Nuxt) do szybkiego tworzenia stron, CMS-ów i aplikacji webowych. 40+ modułów wielokrotnego użytku, system overrides do nadpisywania plików core i pagebuilder z edytorem drag-and-drop - wszystko rozwijane aktywnie od ponad dwóch lat.
...
Nucleify to nowoczesny, modularny full-stackowy framework (zbudowany z Laravel + Vue/Nuxt) zaprojektowany, aby przyspieszyć tworzenie stron internetowych, systemów CMS i aplikacji webowych - bez bólu związanego z przestarzałymi systemami CMS. 
Chcesz tworzyć szybkie, zorganizowane projekty webowe z najlepszymi praktykami i pełną kontrolą nad kodem? Nucleify to Twoje narzędzie.
...
<details> <summary> 🔗 Projekty </summary>
<br>
<table>
  <th>
    Nazwa
...
<details> <summary> 🛠️ Stack technologiczny  </summary>
...
<details><summary> 💬 Kilka rzeczy o mnie  </summary> 
<br>

* :electron: Mój ulubiony setup to [CachyOS](https://cachyos.org/) z [Hyprland](https://hyprland.org/) i dotfilesy [ML4W](https://mylinuxforwork.github.io/dotfiles/) lub [HyDe](https://github.com/HyDE-Project/HyDE)
* 🤖 Wcześniej pracowałem jako programista i operator CNC - nadal się tym interesuję jako właściciel frezarki 3018
* 📓 Wiedzę zdobywam głównie z dokumentacji, forów, od współpracowników i z własnego doświadczenia
* ♟️ Moje ulubione otwarcia w szachach to Partia Szkocka, Gambit Stafforda i Gambit Królewki; uwielbiam też Atomic Chess - [zagraj ze mną](https://lichess.org/@/S1CChess)
* 🧠 Kostka Rubika CFOP sub-20 i Blindfold Old Pochmann 5 min z memoryzacją
* 📚 Książki, które na mnie wpłynęły: [TimelessBooks](https://www.timeless-books.com/)
* 🏆 Kilka ulubionych cytatów:
  - *"Człowiek pozbawiony wiedzy wzrasta niczym wół: rozwija się tylko jego ciało, lecz mądrość nie rośnie."* ~ Siddhartha Gautama
  - *"Kto ma po co żyć, zniesie prawie każde jak."* ~ Friedrich Nietzsche
  - *"Strach nigdy nie osiągnął najwyższego celu."* ~ Bô Yin Râ
  - *"Nie życz sobie, żeby było łatwiej. Życz sobie, żebyś był lepszy."* ~ Jim Rohn
  - *"Nawet myśl o odpoczynku drażni mój umysł."*
    
</details>
<br>


<details><summary> 📊 Statystyki GitHub  </summary> 
<br>
